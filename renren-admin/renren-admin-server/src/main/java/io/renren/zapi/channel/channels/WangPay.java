...
// 老杨的机构:  Yang
@Slf4j
public class WangPay extends PostJsonChannel {
    ...
    public void setChargeMap(ZChargeEntity entity, TreeMap<String, Object> map) {
        ...
        map.put("userid", Integer.parseInt(channelEntity.getMerchantId()));
        map.put("posordersid", entity.getId().toString());
        map.put("time", String.valueOf(System.currentTimeMillis()));
//        map.put("paytype", 808);
         map.put("paytype", entity.getPayCode());
    ...
    public ChannelChargeQueryResponse doChargeQuery(JSONObject jsonObject) {
        ...
        if (code == 1) {
            ...
            if (status == 2 || status == 3) {
                response.setChannelOrder(data.getString("orderid"));

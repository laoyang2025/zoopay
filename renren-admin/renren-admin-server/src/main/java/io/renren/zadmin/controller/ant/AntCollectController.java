...
*/
@RestController
@RequestMapping("zoo/ant/collect")
@Tag(name = "zoo_ant_collect")
public class AntCollectController {
    @Resource
    ...
    @PreAuthorize("hasAuthority('zant:zcharge:page')")
    ...
    @PreAuthorize("hasAuthority('zant:zcharge:info')")
    ...
    @LogOperation("保存")
    @PreAuthorize("hasAuthority('zant:zcharge:save')")
    ...
    @LogOperation("修改")
    @PreAuthorize("hasAuthority('zant:zcharge:update')")
    ...
    @LogOperation("删除")
    @PreAuthorize("hasAuthority('zant:zcharge:delete')")
    ...
    @LogOperation("导出")
    @PreAuthorize("hasAuthority('zant:zcharge:export')")

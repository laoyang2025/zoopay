...
public class HaodaPay extends PostJsonChannel {
    ...
    public void setWithdrawMap(ZWithdrawEntity entity, TreeMap<String, Object> map) {
        ...
        map.put("account_ifsc", entity.getAccountIfsc());
        map.put("bankname", entity.getAccountBank());
        map.put("confirm_acc_number", entity.getAccountNo());
        map.put("requesttype", "IMPS");
        map.put("beneficiary_name", entity.getAccountUser());
        map.put("amount", entity.getAmount());
        map.put("narration", "service");
    ...
    public String request(String url, TreeMap<String, Object> map, String api) {
        return this.postJSON(url, map, getHttpHeaders());
    }

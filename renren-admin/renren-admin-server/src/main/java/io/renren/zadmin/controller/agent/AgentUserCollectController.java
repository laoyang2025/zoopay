...
*/
@RestController
@RequestMapping("zoo/agent/usercollect")
@Tag(name = "zoo_agent_usercollect")
public class AgentUserCollectController {
    @Resource
    ...
    @PreAuthorize("hasAuthority('zagent:zcharge:page')")
    ...
    @PreAuthorize("hasAuthority('zagent:zcharge:info')")
    ...
    @LogOperation("保存")
    @PreAuthorize("hasAuthority('zagent:zcharge:save')")
    ...
    @LogOperation("修改")
    @PreAuthorize("hasAuthority('zagent:zcharge:update')")
    ...
    @LogOperation("删除")
    @PreAuthorize("hasAuthority('zagent:zcharge:delete')")
    ...
    @LogOperation("导出")
    @PreAuthorize("hasAuthority('zagent:zcharge:export')")

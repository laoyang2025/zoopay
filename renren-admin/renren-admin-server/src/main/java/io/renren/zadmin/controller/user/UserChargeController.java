...
*/
@RestController
@RequestMapping("zoo/user/charge")
...
public class UserChargeController {
    ...
    @PreAuthorize("hasAuthority('zuser:zusercharge:page')")
    ...
    @PreAuthorize("hasAuthority('zuser:zusercharge:info')")
    ...
    @LogOperation("保存")
    @PreAuthorize("hasAuthority('zuser:zusercharge:save')")
    ...
    @LogOperation("修改")
    @PreAuthorize("hasAuthority('zuser:zusercharge:update')")
    ...
    @LogOperation("删除")
    @PreAuthorize("hasAuthority('zuser:zusercharge:delete')")
    ...
    @LogOperation("导出")
    @PreAuthorize("hasAuthority('zuser:zusercharge:export')")

...
*/
@RestController
@RequestMapping("zoo/agent/usercharge")
@Tag(name = "zoo_user_charge")
public class AgentUserChargeController {
    @Resource
    ...
    @PreAuthorize("hasAuthority('zagent:zusercharge:page')")
    ...
    @PreAuthorize("hasAuthority('zagent:zusercharge:info')")
    ...
    @LogOperation("保存")
    @PreAuthorize("hasAuthority('zagent:zusercharge:save')")
    ...
    @LogOperation("修改")
    @PreAuthorize("hasAuthority('zagent:zusercharge:update')")
    ...
    @LogOperation("删除")
    @PreAuthorize("hasAuthority('zagent:zusercharge:delete')")
    ...
    @LogOperation("导出")
    @PreAuthorize("hasAuthority('zagent:zusercharge:export')")

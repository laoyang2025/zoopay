...
import io.renren.zadmin.dao.ZChargeHisDao;
import io.renren.zadmin.dto.ZChargeDTO;
import io.renren.zadmin.dto.ZChargeHisDTO;
import io.renren.zadmin.entity.ZChargeEntity;
import io.renren.zadmin.entity.ZChargeHisEntity;
 ...
 */
@Service
public class ZChargeHisServiceImpl extends CrudServiceImpl<ZChargeHisDao, ZChargeHisEntity, ZChargeHisDTO> implements ZChargeHisService {

    @DataFilter
    @Override
    public PageData<ZChargeHisDTO> page(Map<String, Object> params) {
        IPage<ZChargeHisEntity> page = baseDao.selectPage(
                getPage(params, Constant.CREATE_DATE, false),
                applyFilter(params)
        );
        return getPageData(page, ZChargeHisDTO.class);
    }

    @Override
    public QueryWrapper<ZChargeHisEntity> getWrapper(Map<String, Object> params){
        QueryWrapper<ZChargeHisEntity> wrapper = new QueryWrapper<>();

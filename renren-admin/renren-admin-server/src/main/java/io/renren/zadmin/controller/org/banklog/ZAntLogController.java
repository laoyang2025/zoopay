...
*/
@RestController
@RequestMapping("zoo/org/antlog")
@Tag(name = "zoo_org_antlog")
public class ZAntLogController {
    @Resource
    ...
    @PreAuthorize("hasAuthority('sys:zantlog:page')")
    ...
    @PreAuthorize("hasAuthority('sys:zantlog:info')")
    ...
    @LogOperation("保存")
    @PreAuthorize("hasAuthority('sys:zantlog:save')")
    ...
    @LogOperation("修改")
    @PreAuthorize("hasAuthority('sys:zantlog:update')")
    ...
    @LogOperation("删除")
    @PreAuthorize("hasAuthority('sys:zantlog:delete')")
    ...
    @LogOperation("导出")
    @PreAuthorize("hasAuthority('sys:zantlog:export')")

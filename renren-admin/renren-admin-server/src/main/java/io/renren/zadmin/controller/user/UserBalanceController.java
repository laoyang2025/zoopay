...
*/
@RestController
@RequestMapping("zoo/user/balance")
@Tag(name = "zoo_user_balance")
public class UserBalanceController {
    ...
    @PreAuthorize("hasAuthority('zuser:zbalance:page')")
    ...
    @PreAuthorize("hasAuthority('zuser:zbalance:info')")
    ...
    @LogOperation("保存")
    @PreAuthorize("hasAuthority('zuser:zbalance:save')")
    ...
    @LogOperation("修改")
    @PreAuthorize("hasAuthority('zuser:zbalance:update')")
    ...
    @LogOperation("删除")
    @PreAuthorize("hasAuthority('zuser:zbalance:delete')")
    ...
    @LogOperation("导出")
    @PreAuthorize("hasAuthority('zuser:zbalance:export')")

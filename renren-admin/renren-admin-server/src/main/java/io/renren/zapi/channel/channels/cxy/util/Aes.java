...
public class Aes {
	...
	public static String encrypt(String sSrc, String sKey) throws Exception {
		return encrypt(sSrc, sKey,"0102030405060708");
	}
	/**
	 * 
	 * @param sSrc
	...
	public static String llyDecrypt(String sSrc, String sKey) throws Exception {
		return decrypt(sSrc, sKey, "0010010000100100");
	}
	
	public static String llyEncrypt(String sSrc, String sKey) throws Exception {
		return encrypt(sSrc, sKey, "0010010000100100");
	}
	...
	public static String decrypt(String sSrc, String sKey) throws Exception {
		return decrypt(sSrc, sKey, "0102030405060708");
	}
	
	public static void main(String[] args) throws Exception {
		String data="叶明华12133";
		String key="ABCDEFGHABCDEFGH";
		String enData=encrypt(data, key,"0010010000100100");
		System.err.println(enData);
		System.out.println(decrypt(enData, key,"0010010000100100"));
	}
}

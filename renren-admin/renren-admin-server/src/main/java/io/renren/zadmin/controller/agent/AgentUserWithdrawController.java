...
*/
@RestController
@RequestMapping("zoo/agent/userwithdraw")
@Tag(name = "user_withdraw")
public class AgentUserWithdrawController {
    @Resource
    ...
    @PreAuthorize("hasAuthority('zagent:zuserwithdraw:page')")
    ...
    @PreAuthorize("hasAuthority('zagent:zuserwithdraw:info')")
    ...
    @LogOperation("保存")
    @PreAuthorize("hasAuthority('zagent:zuserwithdraw:save')")
    ...
    @LogOperation("修改")
    @PreAuthorize("hasAuthority('zagent:zuserwithdraw:update')")
    ...
    @LogOperation("删除")
    @PreAuthorize("hasAuthority('zagent:zuserwithdraw:delete')")
    ...
    @LogOperation("导出")
    @PreAuthorize("hasAuthority('zagent:zuserwithdraw:export')")

...
*/
@RestController
@RequestMapping("zoo/agent/log")
@Tag(name = "zoo_agent_log")
public class AgentLogController {
    ...
    @LogOperation("保存")
    @PreAuthorize("hasAuthority('zagent:zlog:save')")
    ...
    @LogOperation("修改")
    @PreAuthorize("hasAuthority('zagent:zlog:update')")
    ...
    @LogOperation("删除")
    @PreAuthorize("hasAuthority('zagent:zlog:delete')")

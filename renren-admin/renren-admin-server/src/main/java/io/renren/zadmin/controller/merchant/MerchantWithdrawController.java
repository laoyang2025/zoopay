...
*/
@RestController
@RequestMapping("zoo/merchant/withdraw")
@Tag(name = "zoo_merchant_withdraw")
public class MerchantWithdrawController {
    ...
    @PreAuthorize("hasAuthority('merchant:zwithdraw:page')")
    ...
    @PreAuthorize("hasAuthority('merchant:zwithdraw:info')")
    ...
    @LogOperation("导出")
    @PreAuthorize("hasAuthority('merchant:zwithdraw:export')")

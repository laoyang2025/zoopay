...
*/
@RestController
@RequestMapping("zoo/ant/balancelog")
@Tag(name = "zoo_ant_balancelog")
public class AntBalanceLogController {
    @Resource
    ...
    @PreAuthorize("hasAuthority('zant:zlog:page')")
    public Result<PageData<ZLogDTO>> page(@Parameter(hidden = true) @RequestParam Map<String, Object> params){
        ...
        params.put("ownerType", ZooConstant.OWNER_TYPE_ANT);
    ...
    @PreAuthorize("hasAuthority('zant:zlog:info')")
    ...
    @LogOperation("导出")
    @PreAuthorize("hasAuthority('zant:zlog:export')")
